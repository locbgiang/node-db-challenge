...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
    ...
    Relational Databases is a data software system, SQL is a language used to access that data.

- [ ] Why do tables need a `primary key`?

    To make sure the data is unique and let the developer access the data precisesly.
